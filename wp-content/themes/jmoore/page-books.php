		...
		<div class="container">
			...
			<div class="novel-summary">
				...
				<div class="column-two">
					...
					<a class="link-continueReading" href="">Continue Reading<i class="icon-dbl-arrow-pink"></i></a>
				</div> <!-- /.column-two -->
		...
		<div class="container">
			...
			<div class="short-story-summary">
				...
				<div class="column-two">
					...
					<hr class="purple-hr">
					<p><?php the_field('book_short_description'); ?></p>
					<a class="link-continueReading" href="">Continue Reading <i class="icon-double-arrow"></i></a>
				</div> <!-- /.column-two -->
